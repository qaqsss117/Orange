...
The audit uses a feature-gated Rust test sidecar for response dispatch, authenticated request framing, cancellation, timeouts, rejection, unexpected exit, graceful EOF, and forced reap paths. It also initializes and closes the production Go sidecar with a real decrypted development bootstrap buffer.
