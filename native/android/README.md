...
The package configurator copies the managed sources into Tauri's generated
Android project. Tauri/Wry's build-generated `generated/**` sources remain
third-party output and are rewritten by every Tauri build.
