...
def security_steps() -> list[Step]:
    return [
        ...
        python_step(
            "Data Plane node runtime audit",
            "scripts/security/check_data_plane_nodes.py",
            "--report",
            "artifacts/security/data-plane-nodes.json",
        ),
        python_step(
        ...
        python_step(
            "logout sequence audit",
            "scripts/security/check_logout_sequence.py",
            "--report",
...
def frontend_steps() -> list[Step]:
    return [
        ...
        python_step(
            "UI connection home audit",
            "scripts/security/check_ui_home.py",
            "--report",
            "artifacts/security/ui-home.json",
        ),
